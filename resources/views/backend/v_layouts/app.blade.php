...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="100x100" href="{{ asset('image\image\logotik.jpg') }}">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin1">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b class="logo-icon p-l-20">
                            <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('image\image\logotik.jpg') }}" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{ asset('image\image\tikett.jpg')}}" alt="homepage" class="light-logo" />
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Toko Tiket Online Pontianak <a href="https://bsi.ac.id/">Paling Update !!!</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
