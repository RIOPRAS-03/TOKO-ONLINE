...
<style>
        .auth-wrapper {
            background-image: url('{{ asset("backend/images/konser.png") }}');
        ...
        .auth-box {
            background: rgba(255, 255, 255, 0.9); /* Semi-transparan putih */
            padding: 20px;
            border-radius: 8px;
        }
    </style>
...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-pink">
            <div class="auth-box bg-pink border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="{{ asset('backend/images/banner.jpg') }}" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <!-- error -->
